...
export enum Equipment {
  ...
  LEG_CURL = 'Lårcurl',
  LYING_LEG_CURL = 'Liggande Lårcurl',
  SEATED_LEG_CURL = 'Sittande Lårcurl',
  LEG_ADDUCTION = 'Höftmaskin (Adduktor/Abduktor)',
  LEG_ABDUCTION = 'Höftmaskin (Adduktor/Abduktor)',
  CALF_RAISE = 'Vadpress',
  SMITH_MACHINE = 'Smith-maskin',
  CABLES = 'Kabelmaskin',
  LAT_PULLDOWN = 'Latsdrag',
  SEATED_ROW = 'Sittande Rodd',
  CHEST_SUPPORTED_ROW = 'Bröststödd Rodd',
  T_BAR_ROW = 'T-bar Rodd',
  CHEST_PRESS = 'Bröstpress',
  SHOULDER_PRESS = 'Axelpress',
  LATERAL_RAISE_MACHINE = 'Sidolyft Maskin',
  PEC_DECK = 'Pec Deck / Flyes',
  BICEP_CURL_MACHINE = 'Biceps Maskin',
  TRICEP_EXTENSION_MACHINE = 'Triceps Maskin',
  ASSISTED_MACHINE = 'Assisterad Chins/Dips',
  BODYWEIGHT = 'Kroppsvikt',
  PULLUP_BAR = 'Dipsställning',
